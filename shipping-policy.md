...
<div class="policy-page">
  ...
  <div class="policy-section">
    ...
    <p>All registrations are digital. Upon successful payment, you will receive:</p>
    <ul>
      <li>A digital confirmation via email and/or WhatsApp</li>
      <li>Event details including venue, date, time, and any instructions</li>
    </ul>
  </div>

  <div class="policy-section">
    <h2>No Delivery Charges</h2>
    <p>Since no physical items are shipped, there are no shipping or delivery charges applied to any transaction.</p>
  </div>
